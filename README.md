...
```javascript
acosh = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-fast-acosh@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-fast-acosh@umd/bundle.js"></script>
```
